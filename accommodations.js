        ...
        if (currentUser && currentUser.email) {
            ...
            userBar.innerHTML = `
                <div class="auth-logged-pill" style="${isAdmin ? 'border:1px solid rgba(231,76,60,0.6); background:rgba(231, 76, 60, 0.12);' : 'background:var(--bg-main); border:1px solid var(--border);'} display:inline-flex; align-items:center; gap:6px; padding:3px 8px; border-radius:20px; flex-shrink:0;">
                    <a href="perfil.html" style="text-decoration:none; color:inherit; display:flex; align-items:center; gap:5px; font-weight:700; font-size:0.8rem;" title="${currentUser.email}">
                    ...
                    <button onclick="handleLogout()" class="btn-logout-mini" title="Cerrar sesión" style="background:transparent; border:none; color:var(--text-secondary); cursor:pointer; font-size:0.85rem; padding:2px; display:flex; align-items:center;">
